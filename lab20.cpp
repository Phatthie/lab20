...
int main(){
	...
	if(eq=='1') {sword.getStat(); hero.equip(&sword);}
	else if(eq=='2') {axes.getStat(); hero.equip(&axes);}
	else if(eq=='3') {shield.getStat(); hero.equip(&shield);}
	else if(eq=='4') {armor.getStat(); hero.equip(&armor);} 
